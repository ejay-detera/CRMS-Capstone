...
- Name: profile-change.spec.ts >> Profile Module >> Positive: Update personal details and logout
- Location: e2e\profile-change.spec.ts:33:5
...
Call log:
  - waiting for locator('header').locator('.ring-2') to be visible
    ...
    - navigated to "http://localhost:5173/cms/sales/dashboard?state=/cms/sales/dashboard"
    - waiting for" http://localhost:5173/" navigation to finish...
