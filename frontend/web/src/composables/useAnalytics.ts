...
import type { AggregatedMetricEntry, AnalyticsSummary, DiagnosticInsight, RefreshResult } from '@/types/analytics'

// Feature 4: Analytics — reads analytics-service's /analytics/summary and
// /analytics/diagnostics endpoints. Admin/Manager-only, enforced both by
// the router guard and the backend's auth_role check.
