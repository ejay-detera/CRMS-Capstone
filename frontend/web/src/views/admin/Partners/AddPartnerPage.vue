...
async function handleSubmit() {
  ...
  if (!form.name || form.name.trim().length < 2 || isDuplicate.value || !form.industry || !form.region || !form.contactPerson || !emailValid.value || !phoneValid.value || !form.address || (activeTab === 'suppliers' && !tinValid.value)) {
    return
  }
