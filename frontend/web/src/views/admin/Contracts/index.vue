...
watch([activeFilter, categoryFilter, regionFilter, statusFilter, startDateFilter, endDateFilter, searchQuery], () => {
  currentPage.value = 1
})
...
async function executeExport() {
  ...
  await exportToExcel('sbsi-contracts.xlsx', 'Contracts', rows)
