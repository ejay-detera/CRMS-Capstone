...
const requests = ref<ContractRequest[]>([
  { id: 'REQ-001', businessPartner: 'Philippine National Bank', category: 'Service Agreement',     description: 'ATM maintenance unit for Luzon region branches.',               region: 'Luzon',    requestDate: '2026-01-15', startDate: '2026-03-01', endDate: '2027-02-28', priority: 'High',   status: 'Pending',      notes: 'Urgent — required before Q1 audit.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-002', businessPartner: 'Globe Telecom',            category: 'Partnership Agreement', description: 'Network infrastructure expansion across Luzon corridors.',      region: 'Luzon',    requestDate: '2026-01-18', startDate: '2026-04-01', endDate: '2027-03-31', priority: 'High',   status: 'Under Review', notes: 'Awaiting technical review from IT.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-003', businessPartner: 'MedLine Philippines',      category: 'Supply Contract',       description: 'Surgical supply agreement for Luzon hospitals.',                region: 'Luzon',    requestDate: '2025-12-10', startDate: '2026-02-01', endDate: '2027-01-31', priority: 'Medium', status: 'Approved',     notes: '', rejectionReason: '', contractLink: '#' },
  ...
  { id: 'REQ-005', businessPartner: 'PLDT',                     category: 'Service Agreement',     description: 'Fiber optic maintenance contract for Mindanao operations.',     region: 'Mindanao', requestDate: '2026-02-01', startDate: '2026-05-01', endDate: '2027-04-30', priority: 'Medium', status: 'Pending',      notes: 'Renewal of previous contract.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-006', businessPartner: 'Bio-Tech Logistics',       category: 'Supply Contract',       description: 'Cold chain equipment supply for vaccine distribution.',          region: 'Luzon',    requestDate: '2026-01-22', startDate: '2026-03-15', endDate: '2026-09-15', priority: 'High',   status: 'Under Review', notes: 'Temperature-sensitive logistics required.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-007', businessPartner: 'Cebu Pacific Air',         category: 'Service Agreement',     description: 'Cargo handling equipment services for Visayas routes.',          region: 'Visayas',  requestDate: '2025-12-20', startDate: '2026-02-15', endDate: '2026-08-15', priority: 'Low',    status: 'Approved',     notes: '', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-008', businessPartner: 'SM Prime Holdings',        category: 'Equipment Lease',       description: 'HVAC system lease for SM Mall of Asia expansion units.',         region: 'Luzon',    requestDate: '2026-02-05', startDate: '2026-04-01', endDate: '2027-03-31', priority: 'Medium', status: 'Pending',      notes: 'Property management approved on their end.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-009', businessPartner: 'Global Pharma Inc.',       category: 'Supply Contract',       description: 'Pharmaceutical dispenser units for Visayas distribution.',       region: 'Visayas',  requestDate: '2026-01-30', startDate: '2026-03-20', endDate: '2026-09-20', priority: 'High',   status: 'Under Review', notes: 'Compliance documents submitted.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-010', businessPartner: 'BioGenesis Research',      category: 'Equipment Maintenance', description: 'PCR machine maintenance agreement for Mindanao labs.',           region: 'Mindanao', requestDate: '2025-11-15', startDate: '2026-01-01', endDate: '2026-12-31', priority: 'Medium', status: 'Approved',     notes: '', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-011', businessPartner: 'Stellar Lab Equipment',    category: 'Equipment Lease',       description: 'Centrifuge model X200 lease for clinical laboratory.',            region: 'Luzon',    requestDate: '2025-10-30', startDate: '2026-01-01', endDate: '2026-06-30', priority: 'Low',    status: 'Rejected',     notes: '', rejectionReason: 'Vendor not on approved supplier list. Procurement review required.', contractLink: '#' },
  { id: 'REQ-012', businessPartner: 'PharmaCare Dist.',         category: 'Supply Contract',       description: 'IV fluid supply for hospital network across Luzon.',             region: 'Luzon',    requestDate: '2026-02-10', startDate: '2026-04-15', endDate: '2027-04-14', priority: 'High',   status: 'Pending',      notes: 'Critical supply — stock running low.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-013', businessPartner: 'Metrobank',                category: 'Service Agreement',     description: 'Cash counting machine service agreement for Mindanao offices.',  region: 'Mindanao', requestDate: '2025-12-05', startDate: '2026-02-01', endDate: '2027-01-31', priority: 'Medium', status: 'Approved',     notes: '', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-014', businessPartner: 'LabTech Solutions',        category: 'Equipment Maintenance', description: 'Spectrophotometer SPX-5 calibration and maintenance.',           region: 'Visayas',  requestDate: '2026-02-12', startDate: '2026-05-01', endDate: '2027-04-30', priority: 'Medium', status: 'Under Review', notes: 'ISO certification review in progress.', rejectionReason: '', contractLink: '#' },
  { id: 'REQ-015', businessPartner: 'Philippine Airlines',      category: 'Partnership Agreement', description: 'Ground support equipment partnership for Visayas airports.',      region: 'Visayas',  requestDate: '2026-01-25', startDate: '2026-04-01', endDate: '2026-10-01', priority: 'High',   status: 'Pending',      notes: 'Board approval pending.', rejectionReason: '', contractLink: '#' },
])
