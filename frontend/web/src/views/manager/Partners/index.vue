  ...
  <div class="p-8 space-y-6">
    ...
    <div class="flex items-start justify-between">
      ...
      <div class="flex items-center gap-2">
        ...
        <Button v-if="hasPermission('cms.partners.create')" @click="router.push('/manager/partners/create?type=' + activeTab)" class="h-9 w-9 p-0 bg-brand-navy hover:bg-brand-dark text-white rounded-lg shadow-sm">
          <Plus class="w-5 h-5" />
        </Button>
      </div>
    </div>
