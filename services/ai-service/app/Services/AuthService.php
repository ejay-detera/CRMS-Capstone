 ...
 * already used by contract-management/notification's AuthService +
 * AuthenticateInternal middleware.
 */
class AuthService
{
    ...
    public function verifyToken(string $token): ?array
    {
        try {
            ...
            Log::error('Auth service connection error in ai-service', ['message' => $e->getMessage()]);
            return null;
        }
    }
}
